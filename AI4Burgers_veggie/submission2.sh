...
#SBATCH -C "GPU_SKU:H100_SXM5"        # Only request either H100_SXM5 or L40S. No other gpus work with my flax installation (V100, V100S, V100_SXM2, 
